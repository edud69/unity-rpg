...
public class CreateWeapon : MonoBehaviour 
{
	...
	private PlayerItemsManager.ItemObject m_Weapon;
	...
	void Start () 
	{
		...
		m_Weapon       = PlayerItemsManager.ItemObject.CreateRHandWeaponItem(PlayerItemsManager.ItemType.ITEM_RHAND, 
			                                                                 m_Texture, 
			                                                                 m_attackPwr, 
			                                                                 m_SellValue, 
			                                                                 m_ReqLvl,
	...
	void Update()
	{
		if(m_ItemWasTakenByPlayer)
		{
			...
			else if(!m_ItemPickedUp)
			{
				...
				m_pPlayerMsgSystemManager.AddMsgToLog("Vous ramassez une arme.", PlayerMsgSystemManager.MsgType.MSG_ITEMS);
				renderer.enabled = false; //hide the object untill destruction
				m_pItemsManager.PickupNewItem(ref m_Weapon);
				m_ItemPickedUp = true;
			}
		}
	}
